...
import entityOrb.BottomLeftPiece;
import entityOrb.BottomRightPiece;
import entityOrb.TopLeftPiece;
import entityOrb.TopRightPiece;
...
public class Level1CState extends GameState {
	...
	// Constructor
	public Level1CState(GameStateManager manager) {
		super(manager);
		init();
	}
	...
	public void input() {
		...
		if(Keys.isPressed(Keys.CHARGE)) player.setCharging();
	}
	...
	private void eventFinish() {
		...
		if(eventCount == 60) {
			...
			manager.setState(GameStateManager.POISONSTATE);
		}
	}
